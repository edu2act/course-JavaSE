...
//		public int registerUser(String nickname ,String password,String gender,String introduce){
//			
//			try{
//				//获取数据库连接
//				Connection con1=ConnectionUtil.getCon();
//				//创建statement
//				PreparedStatement pstm1=con1.prepareStatement(
//						"insert into usres(nickname,password,gender,introduce) values(?,?,?,?)");
//				//设置参数，针对？占位符
//				pstm1.setString(1,nickname );
//				pstm1.setString(2, password);
//				pstm1.setString(3, gender);
//				pstm1.setString(4, introduce);
//				//执行sql语句
//				ResultSet rst=pstm.executeQuery();
//				
//				//关闭连接
//				ConnectionUtil.closeCon(rst, pstm1, con1);
//				return qqnum;
//			}catch(Exception e){
//				e.printStackTrace();
//				return null;
